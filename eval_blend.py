...
parser.add_argument('--dataset', default='data_eval_transform_blend_caspl', help='select dataset')
...
parser.add_argument('--view_num', type=int, default=5, help='view num setting,test5/val3')
...
parser.add_argument('--outdir', default='./outputs_blend', help='output dir')
