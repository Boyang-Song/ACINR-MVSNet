...
def filter_depth(scan_folder, out_folder, plyfilename, max_h, max_w, base_image_size):
...
if __name__ == '__main__':
    ...
    for scan in scans:
        ...
        img_w, img_h = image_sizes[scan]
        print("scan:{}, img_w:{}, img_h:{}".format(scan, img_w, img_h))
        base_image_size = 8
        filter_depth(scan_folder, out_folder, os.path.join(args.outdir, scan + '.ply'), img_h, img_w, base_image_size)