...
#######pretrain-test#####
#ckpt=./checkpoints/pretrained/dtu3base.ckpt
#CUDA_VISIBLE_DEVICES=0 python eval.py --dataset=data_eval_transform --testpath=$DTU_TESTING \
#        --testlist=lists/dtu/test.txt \
...
#        --loadckpt=$ckpt --outdir=./outputs_dtu --isTest=True --forTNT=True
#
#CUDA_VISIBLE_DEVICES=0 python depthfusion.py --eval_folder ./outputs_dtu/pretrained_dtu3base.ckpt/depthfusion -n flow2