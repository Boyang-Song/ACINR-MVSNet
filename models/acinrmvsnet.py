...
#################### Implict Neural SR/Propagation ####################
        ...
        inv_depth = self.jiif_net(inv_cur_depth, image, hr_coord, self.dinp_h, self.dinp_w, lr_image)
        inv_depth = inv_depth.reshape(batch_size, 1, self.dinp_h, self.dinp_w)# (B, 1, FH, FW)
