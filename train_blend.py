...
def create_stage_images(image: torch.Tensor) -> List[torch.Tensor]:
    return [
        ...
        F.interpolate(image.unsqueeze(1), (image.shape[1]//8,image.shape[2]//8), mode="nearest").squeeze(1)
    ]
...
parser.add_argument('--trainpath', default="/home/sby/data/MVS_Data/dataset_low_res/",help='train datapath')
parser.add_argument('--trainlist', default='/home/sby/data/MVS_Data/dataset_low_res/training_list.txt', help='train list')
parser.add_argument('--vallist', default='/home/sby/data/MVS_Data/dataset_low_res/validation_list.txt', help='val list')
parser.add_argument('--testlist', default='/home/sby/data/MVS_Data/dataset_low_res/validation_list.txt', help='test list')

parser.add_argument('--batch_size', type=int, default=4, help='train batch size')
parser.add_argument('--epochs', type=int, default=16, help='number of epochs to train')
parser.add_argument('--lr', type=float, default=0.00025, help='learning rate')
parser.add_argument('--wd', type=float, default=0.001, help='weight decay')
parser.add_argument('--lrepochs', type=str, default="6,10,14:2", help='epoch ids to downscale lr and the downscale rate')
...
train_dataset = MVSDataset(args.trainpath, args.trainlist, "train", args.view_num, args.numdepth, \
                           args.inverse_depth, max_h=args.max_h, max_w=args.max_w)
    ...
    if args.forTNT:
        ...
        if detailed_summary:
            ...
            scalar_outputs["abs_depth_error_depth_flow1"] = absolute_depth_error_metrics(
                depth_flow1, depth_gt[2], mask[2] > 0.5)
